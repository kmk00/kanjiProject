...
watch(gradesSelected, () => {
  ...
  filteredWords.value = Object.values(words)
...
const checkIfGradesInOptionSelected = () => {
  ...
  const anySelected = Object.values(gradesSelected).some((grade) =>
  ...
  <div class="mt-4 px-2">
    <Transition @enter="enter" @leave="leave" @before-enter="beforeEnter">
      <div v-if="checkIfGradesInOptionSelected()">
        ...
        <table
          v-else
          class="mx-auto md:text-xl w-3/4 md:max-w-[980px] text-center"
        >
          <thead>
            <tr>
              <th>
              ...
              <th>
                <p class="px-4 flex">
                  <span class="hidden md:block"> Reading &nbsp; </span>
                  on
                </p>
              </th>
              <th>
